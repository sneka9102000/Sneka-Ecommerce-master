...
router.route("/order/new").post(authentication.isAuthenticatedUser,orderController.newOrder);
router.route("/order/:id").get(authentication.isAuthenticatedUser,orderController.getSingleOrder);
router.route("/orders/me").get(authentication.isAuthenticatedUser,orderController.userOrders);
